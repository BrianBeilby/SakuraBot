...
const playlistInfo = (url, options = {}) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        while (continuationToken) {
            const { data } = yield axios_1.default.post(utils_1.constants.urls.playlist.continuation(INNERTUBE_API_KEY), {
            ...
            }, Object.assign(Object.assign({}, options.requestOptions), { responseType: "json" }));
