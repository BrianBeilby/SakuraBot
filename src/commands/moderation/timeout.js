...
module.exports = {
  ...
  callback: async (client, interaction) => {
    ...
    if (targetUserRolePosition >= requestUserRolePosition) {
      await interaction.editReply(
        "You can't timeout that user because they have the same/higher role as you."
      );
      return;
    }
    ...
    if (targetUserRolePosition >= botRolePosition) {
      await interaction.editReply(
        "I can't timeout that user because they have the same/higher role as me."
      );
      return;
    }
  ...
  options: [
    ...
    {
      name: "duration",
      description: "Timeout duration (30m, 1hr, 1day).",
